...
<head>
  ...
  <!-- Icons -->
  <link href="{{URL('argon/js/plugins/nucleo/css/nucleo.css" rel="stylesheet"')}}"/>
  
  <link href="{{URL('argon/js/plugins/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet')}}" />
  <!-- CSS Files -->
  <link href="{{URL('argon/css/argon-dashboard.css?v=1.1.0')}}" rel="stylesheet" />
</head>
...
<body class="">
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="{{URL('argon/img/brand/blue.png')}}" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{URL('argon/img/theme/team-1-800x800.jpg')}}">
              </span>
            </div>
          </a>
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  {{-- <img alt="Image placeholder" src="{{URL('argon/img/theme/team-4-800x800.jpg')}}"> --}}
                </span>
  ...
  <script src="{{URL('argon/js/plugins/jquery/dist/jquery.min.js')}}"></script>
  
  
  <script src="{{URL('argon/js/plugins/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
  <!--   Optional JS   -->
  <script src="{{URL('argon/js/plugins/chart.js/dist/Chart.min.js')}}"></script>
  <script src="{{URL('argon/js/plugins/chart.js/dist/Chart.extension.js')}}"></script>
  <!--   Argon JS   -->
  <script src="{{URL('argon/js/argon-dashboard.min.js?v=1.1.0')}}"></script>
