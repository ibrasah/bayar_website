                                ...
                                <tbody>
                                    @foreach ($all_akun as $item)    
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle="modal" class="btn btn-success btn-xs" href="{{URL('/admin/siswa/detail',  $item['UID'])}}">Detail</a> 
                                                {{-- <button data-toggle="modal" class="btn btn-primary btn-xs" onclick="update('{{$item['UID']}}')" data-id="'+index+'">Update</button>  --}}
                                                <button data-toggle="modal" data-target="#remove-modal" class="btn btn-danger btn-xs removeData" data-id="'+index+'">Delete</button>
                                                {{-- <a href="{{URL('/admin/siswa/delete',  $item['UID'])}}" class="btn btn-danger btn-xs">Delete</a> --}}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
<form action="" method="POST" class="users-remove-record-model">
    <div id="remove-modal" class="modal modal-danger fade in" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" style="width:55%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center><h4>Yakin HAPUS Data Siswa ini?</h4></center>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default waves-effect remove-data-from-delete-form" data-dismiss="modal">Keluar</button>
                    <a href="{{URL('/admin/siswa/delete',  $item['UID'])}}" class="btn btn-success waves-effect waves-light deleteMatchRecord">Yakin</a>
                    {{-- <button type="button" href="{{URL('/admin/siswa/delete',  $item['UID'])}}" class="btn btn-danger waves-effect waves-light deleteMatchRecord">Delete</button> --}}
                </div>
            </div>
        </div>
    </div>
